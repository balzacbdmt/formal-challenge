...
function Card({
  ...
  return (
    <div
      className={`p-6 text-gray-400 bg-slate-100 rounded-2xl flex flex-col h-[350px] md:h-full md:flex-row gap-2 md:gap-8 w-full md:min-w-[600px] md:w-[600px] ${className}`}
